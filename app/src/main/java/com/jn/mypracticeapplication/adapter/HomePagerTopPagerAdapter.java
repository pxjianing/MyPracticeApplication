...
public class HomePagerTopPagerAdapter extends PagerAdapter {
    private List<String> mDataList;
    private List<Integer> mBackgroundList;
    private Context mContext;

    public HomePagerTopPagerAdapter(Context mContext, List<String> dataList, List<Integer> backgroundList) {
        this.mContext = mContext;
        this.mDataList = dataList;
        this.mBackgroundList = backgroundList;
    }

    public HomePagerTopPagerAdapter(List<String> dataList) {
        mDataList = dataList;
    }
